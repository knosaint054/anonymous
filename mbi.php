    ...
    echo '<div class="row">
            <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;">
                <div class="alert alert-dark" role="alert">
                    <img alt="Pipeline" src="verizone.jpg" style="width: 80px;" class="logo">
                    <h4 class="alert-heading">Verizone Logs</h4>
                    <span>
                        <p><b><i>Verizone logs Info</i></b><br></p>
                    </span>
                </div>
