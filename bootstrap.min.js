...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=28b7890192c6fbc754b1)
 * Config saved to config.json and https://gist.github.com/28b7890192c6fbc754b1
 */
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(t) {
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        var i = "disabled",
            ...
            s = n.data();
        e += "Text", null == s.resetText && n.data("resetText", n[o]()), n[o](null == s[e] ? this.options[e] : s[e]), setTimeout(t.proxy(function() {
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                ...
                a = "bottom" == a && d.top + d.height + c - u.scroll > u.height ? "top" : "top" == a && d.top - u.scroll - c < 0 ? "bottom" : "right" == a && d.right + h > u.width ? "left" : "left" == a && d.left - h < u.left ? "right" : a, o.removeClass(p).addClass(a)
            }
        ...
        var c = h.left ? 2 * h.left - o + l : 2 * h.top - s + d,
            p = h.left ? "left" : "top",
            f = h.left ? "offsetWidth" : "offsetHeight";
