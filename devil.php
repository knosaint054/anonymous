                    ...
                    <li class="nav-item col-12 col-sm-6 col-md-4 col-lg-3" style=" margin-top: 50px;">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="strands#a.php?username=<?=$username ?>">Satander(full info) </a>
                            </div>
                        </div>
                    </li>
    ...
    echo '<div class="row">
            <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;">
                <div class="alert alert-dark" role="alert">
                    <img alt="Pipeline" src="Citi-logo.jpg" style="width: 80px;" class="logo">
                    <h4 class="alert-heading">CitiBank Logs</h4>
                    <span>
                        <p><b><i>CitiBank logs Info</i></b><br></p>
                    </span>
                </div>
...
<div class="modal-footer">
    <button type="button" class="btn btn-success" onclick="location.href=\'bitcoin.php?username=' . $username . '&price=' . $row["price"]. '\'">Purchase</button>
</div>
</div>
</div>
</div>';
