                ...
                <ul  class="navbar-nav" style="font-size: 15px !important; display: flex; flex-wrap: wrap;">
                    ...
                    <div class="d-lg-flex align-items-center">
                        ...
                        <button class="btn btn-success btn-block " type="button" id="newContentButton"   aria-haspopup="true" aria-expanded="false">
                            <a href="ovmiit.php?username=<?=$username ?>" style="text-decoration: none; color: #fff;">Vouches</a>
...
if ($result->num_rows > 0) {
    ...
    echo '<div class="row">
            <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;">
                <div class="alert alert-dark" role="alert">
                    <img alt="Pipeline" src="RBS.png" style="width: 80px;" class="logo">
                    <h4 class="alert-heading">RBS Bank Logs</h4>
                    <span>
                        <p><b><i>RBS logs Info</i></b><br></p>
                    </span>
                </div>
    ...
    foreach ($rows as $row) {
        ...
        echo '<td><p>[Login:Password]+Name+Address+DOB+SSN+[Email access]+[State:ILLINOIS]</p></td>';
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Your balance is not enough to make this purchase. Please top up
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="location.href=\'bitcoin.php?username=' . $username . '&price=' . $row["price"]. '\'">Top Up</button>
            </div>
        </div>
    </div>
</div>';
