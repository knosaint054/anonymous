...
if ($result->num_rows > 0) {
    ...
    echo '<div class="row">
            <div class="col-md-12 card" style="padding-left: 0px;padding-right: 0px;">
                <div class="alert alert-dark" role="alert">
                    <img alt="Pipeline" src="trust.png" style="width: 80px;" class="logo">
                    <h4 class="alert-heading"> TRUST Bank Logs</h4>
                    <span>
                        <p><b><i> TRUST Bank logs Info</i></b><br></p>
                    </span>
                </div>
    ...
    foreach ($rows as $row) {
        ...
        echo '<td><p>[Login:Password]+Name+Address+DOB+SSN+[Email access]+[State:Ohio]</p></td>';
